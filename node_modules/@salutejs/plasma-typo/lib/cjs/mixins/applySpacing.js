...
exports.spacing = __assign(__assign({}, baseSpacing), { '0x': baseSpacing[0], '1x': baseSpacing[2], '2x': baseSpacing[4], '4x': baseSpacing[8], '5x': baseSpacing[10], '6x': baseSpacing[12], '8x': baseSpacing[16], '9x': baseSpacing[18], '10x': baseSpacing[20], '12x': baseSpacing[24], '16x': baseSpacing[32] });
var createSpacingFn = function (params) { return function (value) {
    return params.reduce(function (acc, cur) {
        var _a;
        return (__assign(__assign({}, acc), (_a = {}, _a[cur] = exports.spacing[value], _a)));
    }, {});
}; };
