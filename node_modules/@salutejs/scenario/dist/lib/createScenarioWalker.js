...
var buildNormalizedServerAction = function (action) {
...
var createScenarioWalker = function (_a) {
    ...
    return function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var dispatch, normalizedServerAction, saluteHandlerOpts, scenarioState, missingVars;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(req.systemIntent === 'run_app')) return [3 /*break*/, 4];
                        if (!(((_b = req.serverAction) === null || _b === void 0 ? void 0 : _b.action_id) === 'PAY_DIALOG_FINISHED')) return [3 /*break*/, 2];
                        ...
                        return [4 /*yield*/, systemScenario.PAY_DIALOG_FINISHED(saluteHandlerOpts, dispatch)];
                    case 1:
                        _c.sent();
                        return [2 /*return*/];
                    case 2:
                        if (!(req.request.payload.original_intent === 'run_app' ||
                            req.request.messageName === 'RUN_APP')) return [3 /*break*/, 4];
                        return [4 /*yield*/, systemScenario.RUN_APP(saluteHandlerOpts, dispatch)];
                    case 3:
                        _c.sent();
                        return [2 /*return*/];
                    case 4:
                        if (!(req.systemIntent === 'close_app')) return [3 /*break*/, 6];
                        return [4 /*yield*/, systemScenario.CLOSE_APP(saluteHandlerOpts, dispatch)];
                    case 5:
                        _c.sent();
                        return [2 /*return*/];
                    case 6:
                        ...
                        if (!(typeof intents !== undefined && userScenario)) return [3 /*break*/, 10];
                        // restore request from server_action payload
                        if (normalizedServerAction) {
                            Object.entries((normalizedServerAction.parameters || {})).forEach(function (_a) {
                                var key = _a[0], value = _a[1];
                                req.setVariable(key, value);
                            });
                        }
                        if (!(req.voiceAction && typeof recognizer !== 'undefined')) return [3 /*break*/, 8];
                    ...
                    case 8:
                        ...
                        if (normalizedServerAction && typeof intents !== 'undefined') {
                            ...
                            missingVars = missingVariables_1.lookupMissingVariables(normalizedServerAction.action_id, intents, req.variables);
                        ...
                        if (!scenarioState) return [3 /*break*/, 10];
                    ...
                    case 9:
                        ...
                        return [2 /*return*/];
                    case 10: return [4 /*yield*/, systemScenario.NO_MATCH(saluteHandlerOpts, dispatch)];
                    case 11:
                        _c.sent();
                        return [2 /*return*/];
                }
