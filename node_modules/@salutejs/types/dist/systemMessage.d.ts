 ...
 */
export declare type Surface = 'SBERBOX' | 'COMPANION' | 'STARGATE';
/**
...
export declare type PermissionType = 'record_audio' | 'geo' | 'read_contacts' | 'push';
...
export declare type Card = ListCard | GalleryCard | GridCard | DiscoveryCard | WidgetTitleCard | WidgetGallery | WidgetGalleryWithCategories | WidgetSingleCard | WidgetTwoColumns;
/**
 ...
 */
export declare type Dimension = '0x' | '1x' | '2x' | '4x' | '5x' | '6x' | '8x' | '9x' | '10x' | '12x' | '16x';
export declare type CellView = LeftRightCellView | TextCellView | ButtonCellView | ImageCellView | DetailsCellView | WeatherCellView;
export declare type LeftView = SimpleLeftView | FastAnswerLeftView;
/**
 ...
 */
export declare type ImageAddress = {
    /**
     * Тип ресурса.
     */
    type: 'url';
 ...
 */
export declare type LocalImageIdentificator1 = 'add_contactless_payment' | 'apple_wallet' | 'arrow_right_chevron_rectangle' | 'arrow_right_trace_line' | 'arrows_forward_back' | 'atm_banknote' | 'bag' | 'ballot_paper' | 'bar_graph' | 'basket' | 'beach_umbrella' | 'bell' | 'bell_crossed' | 'between_accounts' | 'boarding_pass' | 'bolt' | 'box' | 'building' | 'calculator' | 'camera' | 'candy' | 'capsule' | 'car' | 'card' | 'card_amex' | 'card_amex_black' | 'card_amex_gold' | 'card_blocked' | 'card_chevron_left' | 'card_ghost' | 'card_maestro_null' | 'card_mc' | 'card_mc_black' | 'card_mc_gold' | 'card_mc_null' | 'card_mir' | 'card_mir_black' | 'card_mir_gold' | 'card_mir_null' | 'card_momentum' | 'card_on_card' | 'card_plus' | 'card_pro100_null' | 'card_uek' | 'card_viewfinder' | 'card_visa_gold' | 'card_visa_black' | 'card_visa' | 'card_visa_infinite_sber' | 'card_visa_infinite' | 'card_visa_digital' | 'card_visa_null' | 'cards_carousel' | 'case' | 'case_diagram' | 'chess_piece' | 'circle_cross' | 'circle_plus' | 'clock' | 'coat_of_arms' | 'coin' | 'coin_heart' | 'color_spasibo' | 'color_total' | 'counterclock_wise' | 'crown' | 'digital_banknotes' | 'document' | 'document_checkmark' | 'document_magnifying_glass' | 'document_on_document' | 'drop' | 'ellipsis' | 'eye' | 'eye_crossed' | 'face' | 'face_id' | 'falling_coin' | 'file_pdf' | 'fingerprint' | 'flag' | 'flame' | 'flasher' | 'funnel' | 'gamepad' | 'gear' | 'gift' | 'globe' | 'hammer' | 'handset' | 'heart' | 'heart_hand' | 'house' | 'house_handset' | 'house_percent' | 'info' | 'key' | 'list' | 'lock_closed' | 'lock_opened' | 'magnit' | 'mail' | 'mail_eye' | 'mail_waves' | 'man_badge' | 'man_wheelchair' | 'map' | 'mask' | 'mindmap' | 'mobile' | 'mobile_plus' | 'mobile_plus_alt' | 'mobile_waves' | 'necklace' | 'note' | 'notebook_waves' | 'open_book' | 'other' | 'paper_tray' | 'parking' | 'passport' | 'paw' | 'pencil_line' | 'percent' | 'pfm' | 'photo' | 'pie_chart' | 'placeholder' | 'plane' | 'play' | 'postcard_heart' | 'pram' | 'qr_code' | 'receipt' | 'rectangle_on_dashed_rectangle' | 'rectangle_speech_bubble' | 'rectangle_speech_bubble_on_speech_bubble' | 'rectangle_watches' | 'round_speech_bubble_question' | 'round_watches' | 'ruble_dollar' | 'ruble_plus' | 'safe' | 'safe_diagram' | 'sber' | 'security_camera' | 'shield' | 'shield_check' | 'shield_crossed' | 'shield_lines' | 'shield_lines_circles' | 'spasibo' | 'speaker_waves' | 'square_on_square' | 'star_light' | 'student_hat' | 'telephone' | 'thermometer' | 'trash' | 'tv_set' | 'umbrella' | 'user' | 'user_cross' | 'user_on_user' | 'vibration' | 'wallet' | 'watering_can' | 'waves' | 'waves_cross' | 'whistle' | 'wrench' | 'yule';
/**
 ...
 */
export declare type Color = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
 ...
 */
export declare type Typeface = 'headline1' | 'headline2' | 'headline3' | 'title1' | 'title2' | 'body1' | 'body2' | 'body3' | 'text1' | 'paragraphText1' | 'paragraphText2' | 'footnote1' | 'footnote2' | 'button1' | 'button2' | 'caption';
/**
...
export declare type RightView = DisclosureRightView | DetailRightView | RoundButtonCellView | TagCellView;
/**
 * Цвет фона см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=19%3A15
 */
export declare type Color1 = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
/**
 * Цвет фона см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=19%3A15
 */
export declare type Color2 = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
export declare type Actions1 = [Action, ...Action[]];
/**
 * Цвет фона см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=19%3A15
 */
export declare type Color3 = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
/**
 * Стиль текста, см https://www.figma.com/file/D0AfmXWT5KBPiWFNg2IZoF/SmartX-Typeface?node-id=0%3A1
 */
export declare type Typeface1 = 'headline1' | 'headline2' | 'headline3' | 'title1' | 'title2' | 'body1' | 'body2' | 'body3' | 'text1' | 'paragraphText1' | 'paragraphText2' | 'footnote1' | 'footnote2' | 'button1' | 'button2' | 'caption';
export declare type Actions2 = [Action, ...Action[]];
/**
 * Адрес картинки в локальном пространстве клиента https://www.figma.com/file/MQHBgPkW4dqXmI2549WioI/Dev?node-id=19%3A9
 */
export declare type LocalImageIdentificator2 = 'add_contactless_payment' | 'apple_wallet' | 'arrow_right_chevron_rectangle' | 'arrow_right_trace_line' | 'arrows_forward_back' | 'atm_banknote' | 'bag' | 'ballot_paper' | 'bar_graph' | 'basket' | 'beach_umbrella' | 'bell' | 'bell_crossed' | 'between_accounts' | 'boarding_pass' | 'bolt' | 'box' | 'building' | 'calculator' | 'camera' | 'candy' | 'capsule' | 'car' | 'card' | 'card_amex' | 'card_amex_black' | 'card_amex_gold' | 'card_blocked' | 'card_chevron_left' | 'card_ghost' | 'card_maestro_null' | 'card_mc' | 'card_mc_black' | 'card_mc_gold' | 'card_mc_null' | 'card_mir' | 'card_mir_black' | 'card_mir_gold' | 'card_mir_null' | 'card_momentum' | 'card_on_card' | 'card_plus' | 'card_pro100_null' | 'card_uek' | 'card_viewfinder' | 'card_visa_gold' | 'card_visa_black' | 'card_visa' | 'card_visa_infinite_sber' | 'card_visa_infinite' | 'card_visa_digital' | 'card_visa_null' | 'cards_carousel' | 'case' | 'case_diagram' | 'chess_piece' | 'circle_cross' | 'circle_plus' | 'clock' | 'coat_of_arms' | 'coin' | 'coin_heart' | 'color_spasibo' | 'color_total' | 'counterclock_wise' | 'crown' | 'digital_banknotes' | 'document' | 'document_checkmark' | 'document_magnifying_glass' | 'document_on_document' | 'drop' | 'ellipsis' | 'eye' | 'eye_crossed' | 'face' | 'face_id' | 'falling_coin' | 'file_pdf' | 'fingerprint' | 'flag' | 'flame' | 'flasher' | 'funnel' | 'gamepad' | 'gear' | 'gift' | 'globe' | 'hammer' | 'handset' | 'heart' | 'heart_hand' | 'house' | 'house_handset' | 'house_percent' | 'info' | 'key' | 'list' | 'lock_closed' | 'lock_opened' | 'magnit' | 'mail' | 'mail_eye' | 'mail_waves' | 'man_badge' | 'man_wheelchair' | 'map' | 'mask' | 'mindmap' | 'mobile' | 'mobile_plus' | 'mobile_plus_alt' | 'mobile_waves' | 'necklace' | 'note' | 'notebook_waves' | 'open_book' | 'other' | 'paper_tray' | 'parking' | 'passport' | 'paw' | 'pencil_line' | 'percent' | 'pfm' | 'photo' | 'pie_chart' | 'placeholder' | 'plane' | 'play' | 'postcard_heart' | 'pram' | 'qr_code' | 'receipt' | 'rectangle_on_dashed_rectangle' | 'rectangle_speech_bubble' | 'rectangle_speech_bubble_on_speech_bubble' | 'rectangle_watches' | 'round_speech_bubble_question' | 'round_watches' | 'ruble_dollar' | 'ruble_plus' | 'safe' | 'safe_diagram' | 'sber' | 'security_camera' | 'shield' | 'shield_check' | 'shield_crossed' | 'shield_lines' | 'shield_lines_circles' | 'spasibo' | 'speaker_waves' | 'square_on_square' | 'star_light' | 'student_hat' | 'telephone' | 'thermometer' | 'trash' | 'tv_set' | 'umbrella' | 'user' | 'user_cross' | 'user_on_user' | 'vibration' | 'wallet' | 'watering_can' | 'waves' | 'waves_cross' | 'whistle' | 'wrench' | 'yule';
/**
 * Режим растягивания изображения
 */
export declare type ScaleMode = 'scale_aspect_fill' | 'scale_aspect_fit' | 'center' | 'top' | 'bottom' | 'left' | 'right' | 'top_left' | 'top_right' | 'bottom_left' | 'bottom_right';
/**
 * Цвет фона см https://www.figma.com/file/yaeE0lLDWMBKKLXuDHgq1p/SmartX-Styles?node-id=19%3A15
 */
export declare type Color4 = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
/**
 ...
 */
export declare type ContentWidth = 'xsmall' | 'small' | 'medium' | 'large' | 'resizable';
/**
 ...
 * Ширина контента в терминах сеток. https://www.figma.com/file/L6AlpyUxFuumKEEbh4ADIh/🤖SD-Styles?node-id=26%3A17 https://www.figma.com/file/c6KZ9jIXTB5zEmyTfA2Akv/Message-Based?node-id=1446%3A0
 */
export declare type ContentWidth1 = 'xsmall' | 'small' | 'medium' | 'large' | 'resizable';
/**
 ...
 * Ширина контента в терминах сеток. https://www.figma.com/file/L6AlpyUxFuumKEEbh4ADIh/🤖SD-Styles?node-id=26%3A17 https://www.figma.com/file/c6KZ9jIXTB5zEmyTfA2Akv/Message-Based?node-id=1446%3A0
 */
export declare type ContentWidth2 = 'xsmall' | 'small' | 'medium' | 'large' | 'resizable';
/**
 * Карточка с вертикальным списком ячеек для отображения в ленте.
 */
export declare type DiscoveryCard = CardBase & {
    /**
 ...
 */
export declare type ObjectObject = [[unknown, ...unknown[]], ...[unknown, ...unknown[]][]];
export declare type Actions3 = [Action, ...Action[]];
/**
