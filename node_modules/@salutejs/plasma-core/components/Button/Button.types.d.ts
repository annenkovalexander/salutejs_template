...
export declare type ButtonContentProps = 
/**
 ...
 * @private
 */
export interface StyledButtonProps extends ButtonViewProps, ButtonSizeProps, PinProps, FocusProps, OutlinedProps, DisabledProps, ShiftProps, BlurProps, ButtonIsContentProps, Pick<ButtonProps, 'square' | 'stretch'> {
}
/**
 * @private
 */
