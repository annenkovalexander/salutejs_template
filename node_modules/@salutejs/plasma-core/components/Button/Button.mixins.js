...
exports.getButtonSizesMixin = void 0;
...
(0, _collectPackageInfo.collectPackageInfo)('Button/Button.mixins');
...
var getButtonSizesMixin = function getButtonSizesMixin(sizes, typos) {
  return function (_ref) {
    ...
    return (0, _styledComponents.css)(["height:", ";padding:", " ", ";border-radius:", ";", " ", " ", " ", " ", " ", ""], sizes[size].height, sizes[size].paddingY, paddingX, (0, _utils.convertRoundnessMatrix)(pin, sizes[size].radius, sizes[size].radiusCircle), stretch && 'width: 100%;', square && " width: ".concat(sizes[size].height, ";"), shiftLeft && "margin-left: calc(-1 * ".concat(paddingX, ");"), shiftRight && "margin-right: calc(-1 * ".concat(paddingX, ");"), typos[size], (0, _mixins.addFocus)(_objectSpread(_objectSpread({}, theme), {}, {
      focused: focused,
      outlined: outlined,
...
exports.getButtonSizesMixin = getButtonSizesMixin;