...
exports.translateToIndex = translateToIndex;
exports.getItemSlot = exports.scrollToPos = exports.getCalculatedOffset = exports.getCalculatedPos = void 0;
...
var scrollToPos = function scrollToPos(_ref3) {
  ...
  if (axis === 'y' && Math.abs(pos - scrollEl.scrollTop) > 1) {
    if (animated) {
      (0, _utils.animatedScrollToY)(scrollEl, pos, duration, timingFunction);
    } else {
      scrollEl.scrollTo({
        top: pos
      });
...
function translateToIndex(index, prevIndex, axis, align, track, carousel, disableAnimation, scrollMode) {
