...
exports.convertRoundnessMatrix = exports.pins = void 0;
...
var convertRoundnessMatrix = function convertRoundnessMatrix(matrixKey, r, h) {
  return matrixKey && pins[matrixKey].split(' ').map(function (_char) {
    switch (_char) {
      case 'r':
        return r;
...
exports.convertRoundnessMatrix = convertRoundnessMatrix;