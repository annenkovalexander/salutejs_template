...
collectPackageInfo('Stepper/StepperButton');

/**
 * Стилизованная кнопка, применяемая для контроля над значением степпера.
 */
export var StepperButton = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef( // eslint-disable-next-line prefer-arrow-callback
