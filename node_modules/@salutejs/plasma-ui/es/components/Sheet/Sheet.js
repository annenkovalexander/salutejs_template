...
})(["border-radius:1.5rem 1.5rem 0 0;background-color:", ";padding:1rem;max-height:100%;overflow:auto;&::-webkit-scrollbar{display:none;}"], backgroundPrimary);
var StyledSheetHandle = /*#__PURE__*/styled.div.withConfig({
  componentId: "plasma-ui__sc-1c9dnkw-4"
})(["width:4rem;padding:1.75rem 0;margin:-1.5rem 0;opacity:0.65;align-self:center;&::before{content:'';display:block;border-radius:0.625rem;background-color:", ";height:0.25rem;}"], primary);
/**
