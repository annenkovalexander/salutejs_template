 ...
 */
export var TimePicker = function TimePicker(_ref3) {
  var id = _ref3.id,
  ...
  var isFirstMounted = React.useRef(true); // Диапазоны для списков зависят от min и max,
  ...
  var onHoursChange = React.useCallback(function (_ref4) {
    var h = _ref4.value;
  ...
  var onMinutesChange = React.useCallback(function (_ref7) {
    var m = _ref7.value;
  ...
  var onSecondsChange = React.useCallback(function (_ref10) {
    var s = _ref10.value;
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (!isFirstMounted.current || isChanged(prevTime, [hours, minutes, seconds])) {
      onChange === null || onChange === void 0 ? void 0 : onChange(getNewDate(value, [hours, minutes, seconds]));
    }
  ...
  return /*#__PURE__*/React.createElement(StyledWrapper, _extends({
    id: id
  }, rest), options.hours && /*#__PURE__*/React.createElement(SimpleTimePicker, {
    id: id,
    type: "hours",
    autofocus: autofocus,
    disabled: disabled,
    ...
    $size: size
  }), options.minutes && /*#__PURE__*/React.createElement(SimpleTimePicker, {
    id: id,
    type: "minutes",
    ...
    $size: size
  }), options.seconds && /*#__PURE__*/React.createElement(SimpleTimePicker, {
    id: id,
    type: "seconds",
