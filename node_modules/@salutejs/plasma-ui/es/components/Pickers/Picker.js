...
export var Picker = function Picker(_ref5) {
  ...
  var theme = useThemeContext(); // by default 'true' on high performance devices
  ...
  var prevValue = usePreviousValue((_virtualItems$index = virtualItems[index]) === null || _virtualItems$index === void 0 ? void 0 : _virtualItems$index.value); // TODO: https://github.com/salute-developers/plasma/issues/247
