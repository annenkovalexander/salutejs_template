...
exports.TimePicker = exports.DatePicker = exports.Default = void 0;

var _react = /*#__PURE__*/_interopRequireDefault( /*#__PURE__*/require("react"));

var _styledComponents = /*#__PURE__*/_interopRequireDefault( /*#__PURE__*/require("styled-components"));

var _DatePicker = /*#__PURE__*/require("./DatePicker");

var _TimePicker = /*#__PURE__*/require("./TimePicker");
...
var Default = function Default() {
  ...
  var _React$useState = _react["default"].useState(parseDateTime(args.initialValue)),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      value = _React$useState2[0],
      setValue = _React$useState2[1];

  var min = _react["default"].useMemo(function () {
    return parseDateTime(args.minDate);
  }, [args.minDate]);

  var max = _react["default"].useMemo(function () {
  ...
  var dateOptions = _react["default"].useMemo(function () {
    return {
      years: years,
      months: months,
      days: days,
  ...
  var timeOptions = _react["default"].useMemo(function () {
    return {
      hours: hours,
      minutes: minutes,
      seconds: seconds
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledWrapper, null, /*#__PURE__*/_react["default"].createElement(_DatePicker.DatePicker, {
...
var DatePicker = function DatePicker() {
  ...
  var _React$useState3 = _react["default"].useState(parseDateTime(initialValue)),
  ...
  return /*#__PURE__*/_react["default"].createElement(_DatePicker.DatePicker, _extends({
...
var TimePicker = function TimePicker() {
  ...
  var _React$useState5 = _react["default"].useState(parseDateTime(initialValue)),
  ...
  return /*#__PURE__*/_react["default"].createElement(_TimePicker.TimePicker, _extends({
    key: "".concat(rest.size, "-").concat(rest.visibleItems),
    id: "picker",
    value: value,
    min: min,
