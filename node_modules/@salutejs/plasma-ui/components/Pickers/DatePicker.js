...
var _SimpleDatePicker = /*#__PURE__*/require("./SimpleDatePicker");
...
(0, _collectPackageInfo.collectPackageInfo)('Pickers/DatePicker');
var defaultOptions = {
  years: true,
  months: true,
  days: true,
...
var DatePicker = function DatePicker(_ref3) {
  ...
  var normalizeValues = _react["default"].useMemo(function () {
    return (0, _utils.getNormalizeValues)(_utils.getDateValues, getSeconds)(value, min, max);
  }, [value]);

  var _React$useState = _react["default"].useState(normalizeValues),
  ...
  var _getDateValues = (0, _utils.getDateValues)(min),
  ...
  var _getDateValues3 = (0, _utils.getDateValues)(max),
  ...
  var _React$useMemo3 = _react["default"].useMemo(function () {
  ...
  var _React$useMemo5 = _react["default"].useMemo(function () {
    return [(0, _utils.getRange)(daysFrom, daysTo)];
  }, [daysFrom, daysTo]),
      _React$useMemo6 = _slicedToArray(_React$useMemo5, 1),
      daysRange = _React$useMemo6[0];

  var _React$useMemo7 = _react["default"].useMemo(function () {
    return [(0, _utils.getRange)(monthsFrom, monthsTo)];
  }, [monthsFrom, monthsTo]),
      _React$useMemo8 = _slicedToArray(_React$useMemo7, 1),
      monthsRange = _React$useMemo8[0];

  var _React$useMemo9 = _react["default"].useMemo(function () {
    return [(0, _utils.getRange)(minYear, maxYear)];
  }, [minYear, maxYear]),
      _React$useMemo10 = _slicedToArray(_React$useMemo9, 1),
      yearRange = _React$useMemo10[0];

  var getNextMonth = _react["default"].useCallback(function (currentMonth, currentYear) {
  ...
  var getNextDay = _react["default"].useCallback(function (nextDay, nextMonth, nextYear) {
    ...
    return nextDay;
  }, [minDay, maxDay, maxMonth, minYear, maxYear]); // TODO: https://github.com/salute-developers/plasma/issues/242


  var onYearChange = _react["default"].useCallback(function (_ref4) {
    var y = _ref4.value;
  ...
  }, [getNextDay, getNextMonth]); // TODO: https://github.com/salute-developers/plasma/issues/242


  var onMonthChange = _react["default"].useCallback(function (_ref7) {
    var m = _ref7.value;
  ...
  }, [getNextDay]); // TODO: https://github.com/salute-developers/plasma/issues/242


  var onDayChange = _react["default"].useCallback(function (_ref10) {
    var d = _ref10.value;
  ...
  (0, _plasmaCore.useIsomorphicLayoutEffect)(function () {
    ...
    if (onChange && (0, _utils.isChanged)(oldDate, [year, month, day])) {
      onChange(_construct(Date, [year, month, day].concat(_toConsumableArray((0, _utils.getTimeValues)(value)))));
    }
  }, [year, month, day]);
  /**
  ...
  (0, _plasmaCore.useIsomorphicLayoutEffect)(function () {
    setState(function (prevDate) {
      ...
      if (!(0, _utils.isChanged)(prevDate, newDate)) {
        return prevDate;
      }
      ...
      if (onChange) {
        ...
        onChange(_construct(Date, [newYear, newMonth, newDay].concat(_toConsumableArray((0, _utils.getTimeValues)(value)))));
      }
  ...
  var newTime = (0, _utils.getValuesInRange)([yearRange, monthsRange, daysRange], [year, month, day], value);

  if ((0, _utils.isChanged)([year, month, day], newTime)) {
    setState(newTime);
  }

  return /*#__PURE__*/_react["default"].createElement(StyledWrapper, _extends({
    id: id
  }, rest), daysOption && /*#__PURE__*/_react["default"].createElement(_SimpleDatePicker.SimpleDatePicker, {
    id: id,
    autofocus: autofocus,
    size: size,
    type: "day",
  ...
  }), monthsOption && /*#__PURE__*/_react["default"].createElement(_SimpleDatePicker.SimpleDatePicker, {
    id: id,
    ...
    disableScrollSnapAlign: disableScrollSnapAlign
  }), yearsOption && /*#__PURE__*/_react["default"].createElement(_SimpleDatePicker.SimpleDatePicker, {
    id: id,
