...
exports.usePreviousValue = exports.getRange = exports.getValuesInRange = exports.getNormalizeValues = exports.isChanged = exports.getDateValues = exports.getTimeValues = exports.getNewDate = exports.scaleResetCallback = exports.scaleCallbacks = exports.getStyles = void 0;
...
var getStyles = function getStyles(slot, size) {
...
exports.scaleCallbacks = scaleCallbacks;

var scaleResetCallback = function scaleResetCallback(itemEl) {
  if (itemEl.children[0] instanceof HTMLElement) {
...
exports.scaleResetCallback = scaleResetCallback;

var getNewDate = function getNewDate(value, _ref) {
...
var getTimeValues = function getTimeValues(date) {
...
var isChanged = function isChanged(oldValues, newValues) {
...
var getNormalizeValues = function getNormalizeValues(getValues, getSeconds) {
...
exports.getNormalizeValues = getNormalizeValues;
...
var getValuesInRange = function getValuesInRange(_ref3, _ref4, value) {
  ...
  if (firstRange.indexOf(first) === -1 || secondRange.indexOf(second) === -1 || thirdRange.indexOf(third) === -1) {
    ...
    var newThird = thirdRange.indexOf(third) === -1 ? getClosestValue(thirdRange, third) : third; // eslint-disable-next-line no-restricted-globals
...
exports.getValuesInRange = getValuesInRange;
