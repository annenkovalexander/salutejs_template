...
var _PickerItem = /*#__PURE__*/require("./PickerItem");
...
var StyledArrow = /*#__PURE__*/(0, _styledComponents["default"])(_Button.Button).withConfig({
  componentId: "plasma-ui__sc-xqn1h0-0"
})(["position:absolute;left:0;right:0;margin:0 auto;padding:0;width:1.25rem;height:1.25rem;opacity:0;color:", ";&[data-placement='top']{top:0;}&[data-placement='bottom']{bottom:0;}"], _plasmaTokens.primary);
var StyledCarousel = /*#__PURE__*/(0, _styledComponents["default"])(_Carousel.Carousel).withConfig({
  ...
  return $isFocused && (0, _styledComponents.css)(["& ", "{color:", ";}& ~ ", "{opacity:0.32;}"], _PickerItem.StyledWhiteText, _plasmaTokens.primary, StyledArrow);
});
...
var StyledWrapper = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  ...
  return (0, _styledComponents.css)(["height:", ";", "{mask-image:", ";}"], sizes[$size][$visibleItems].height, StyledCarousel, masks[$size][$visibleItems]);
}, _plasmaCore.applyDisabled, function (_ref3) {
  var $disabled = _ref3.$disabled;
  return $disabled && (0, _styledComponents.css)(["", "{overflow:hidden;}", "{cursor:not-allowed;}"], StyledCarousel, _PickerItem.StyledPickerItem);
}, function (_ref4) {
  var $controls = _ref4.$controls;
  return $controls && (0, _styledComponents.css)(["padding-top:1.25rem;padding-bottom:1.25rem;"]);
 ...
 */
var Picker = function Picker(_ref5) {
  var _rest$infiniteScroll, _virtualItems$index;

  var id = _ref5.id,
      _ref5$size = _ref5.size,
      size = _ref5$size === void 0 ? _types.DEFAULT_PICKER_SIZE : _ref5$size,
      value = _ref5.value,
      items = _ref5.items,
      controls = _ref5.controls,
      autofocus = _ref5.autofocus,
      _ref5$visibleItems = _ref5.visibleItems,
      visibleItems = _ref5$visibleItems === void 0 ? _types.DEFAULT_VISIBLE_ITEMS : _ref5$visibleItems,
  ...
  var theme = (0, _hooks.useThemeContext)(); // by default 'true' on high performance devices
  ...
  var isFirstRender = (0, _hooks2.useFirstRender)();
  ...
  var _useState3 = (0, _react.useState)(findItemIndex(virtualItems, value, infiniteScroll)),
      _useState4 = _slicedToArray(_useState3, 2),
      index = _useState4[0],
      setIndex = _useState4[1];

  var _useState5 = (0, _react.useState)(!_utils.IS_REACT_18),
  ...
  var jump = (0, _react.useCallback)(function (cmd) {
    if (disabled) {
      return;
    }
  ...
  var prevValue = (0, _utils2.usePreviousValue)((_virtualItems$index = virtualItems[index]) === null || _virtualItems$index === void 0 ? void 0 : _virtualItems$index.value); // TODO: https://github.com/salute-developers/plasma/issues/247
  ...
  }, [disabled]); // Изменяет индекс выделенного элемента
  // при обновлении значения value извне

  (0, _plasmaCore.useIsomorphicLayoutEffect)(function () {
    var _virtualItems$newInde;

    var newIndex = findItemIndex(virtualItems, value, infiniteScroll); // Отключаем анимацию скролла, если значение компонента осталось
    ...
    setIndex(newIndex);
  }, [value, virtualItems, infiniteScroll, max]); // Навигация с помощью пульта/клавиатуры
  // Не перелистывает, если компонент неактивен

  (0, _hooks.useRemoteListener)(function (key, event) {
  ...
  var onDetectActiveItem = (0, _react.useCallback)(function (i) {
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledWrapper, _extends({
    ...
    onFocus: onFocus,
    onBlur: onBlur
  }, rest), /*#__PURE__*/_react["default"].createElement(StyledCarousel, _extends({
    ref: carouselRef,
    axis: "y",
    index: index,
    scaleCallback: _utils2.scaleCallbacks[size],
    scaleResetCallback: _utils2.scaleResetCallback,
    ...
    return /*#__PURE__*/_react["default"].createElement(_PickerItem.PickerItem, {
      key: "item:".concat(i),
      item: item,
      index: i,
      activeIndex: index,
  ...
  })), hasControls && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(StyledArrow, {
    "data-placement": "top",
    tabIndex: -1,
    view: "clear",
    outlined: false,
    contentLeft: _IconChevronUp || (_IconChevronUp = /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconChevronUp, {
      size: "s"
    })),
    "aria-hidden": "true",
    onClick: toPrev
    ...
    view: "clear",
    outlined: false,
    contentLeft: _IconChevronDown || (_IconChevronDown = /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconChevronDown, {
      size: "s"
    })),
    "aria-hidden": "true",
    onClick: toNext
