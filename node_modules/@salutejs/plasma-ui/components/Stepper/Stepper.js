...
var _StepperButton = /*#__PURE__*/require("./StepperButton");

var _StepperRoot = /*#__PURE__*/require("./StepperRoot");

var _StepperValue = /*#__PURE__*/require("./StepperValue");

var _Stepper = /*#__PURE__*/require("./Stepper.hooks");
...
(0, _collectPackageInfo.collectPackageInfo)('Stepper/Stepper');
...
var Stepper = function Stepper(_ref) {
  ...
  var onRemoveClick = _react["default"].useCallback(function (e) {
    return onRemove === null || onRemove === void 0 ? void 0 : onRemove(e);
  }, [onRemove]);

  return /*#__PURE__*/_react["default"].createElement(_StepperRoot.StepperRoot, rest, /*#__PURE__*/_react["default"].createElement(_StepperButton.StepperButton, {
    "aria-label": isMin && remover ? ariaLabelRemove : ariaLabelDecrement,
    disabled: disabled || !remover && isLessDisabled,
    icon: isMin && remover ? _IconClose || (_IconClose = /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconClose, {
      color: "inherit",
      size: "xs"
    })) : _IconMinus || (_IconMinus = /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconMinus, {
      color: "inherit",
      size: "xs"
    })),
    ...
    onFocus: onFocus,
    onBlur: onBlur
  }), /*#__PURE__*/_react["default"].createElement(_StepperValue.StepperValue, {
    value: value,
    disabled: disabled,
    showWarning: isMax,
    formatter: formatter
  }), /*#__PURE__*/_react["default"].createElement(_StepperButton.StepperButton, {
    "aria-label": ariaLabelIncrement,
    disabled: disabled || isMoreDisabled,
    icon: _IconPlus || (_IconPlus = /*#__PURE__*/_react["default"].createElement(_plasmaIcons.IconPlus, {
      color: "inherit",
      size: "xs"
    })),
    pin: pin,
