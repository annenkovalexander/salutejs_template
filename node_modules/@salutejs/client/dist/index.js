...
if (typeof window !== 'undefined') {
    // eslint-disable-next-line no-underscore-dangle
    window.__ASSISTANT_CLIENT__ = { version: '1.16.2' };
}
    ...
    subscriptions.push(transport.on('open', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    _b.apply(_a, _c.concat([(_d.token = _f.sent(), _d)]));
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _f.sent();
                    emit('error', {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, convertFieldValuesToString(__assign(__assign(__assign({}, sdkMeta), { time: getTime(), current_app: current_app,
