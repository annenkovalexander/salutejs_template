...
import { AppInfo, AssistantAppState, AssistantSmartAppData, AssistantStartSmartSearch, VpsConfiguration, EmotionId, OriginalMessageType, SystemMessageDataType, CharacterId, AssistantBackgroundApp, AssistantMeta, AssistantCommand, HistoryMessages } from '../typings';
...
export declare const createAssistant: ({ getMeta, getInitialMeta, ...configuration }: VpsConfiguration & CreateAssistantDevOptions) => {
