...
export declare const appInitialData: {
     ...
     */
    pull: () => AssistantClientCustomizedCommand<AssistantSmartAppCommand<string, any>>[];
    /**
     * Прочитать appInitialData
     * @returns Массив комманд
     */
    get: () => AssistantClientCustomizedCommand<AssistantSmartAppCommand<string, any>>[];
    /**
     ...
     * @returns Массив комманд
     */
    diff: () => AssistantClientCustomizedCommand<AssistantSmartAppCommand<string, any>>[];
    /**
